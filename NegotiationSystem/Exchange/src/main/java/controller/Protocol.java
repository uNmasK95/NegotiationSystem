...
public final class Protocol {
  ...
  public static final class LoginReply extends
    ...
    private LoginReply(boolean noInit) { this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance(); }

    private static final LoginReply defaultInstance;
  ...
  bitField0_ |= 0x00000001;
    ...
    static {
      defaultInstance = new LoginReply(true);
      defaultInstance.initFields();
    }
  ...
  public static final class Request extends
    ...
    private controller.Protocol.Request.Type type_;
    /**
     * <code>required .controller.Request.Type type = 1;</code>
     */
    ...
    private void initFields() {
      type_ = controller.Protocol.Request.Type.Buy;
      company_ = "";
      quant_ = 0;
      price_ = 0F;
    }
    ...
    public static controller.Protocol.Request parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static controller.Protocol.Request parseFrom(
    ...
    public static final class Builder extends
      ...
      // Construct using controller.Protocol.Request.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public controller.Protocol.Request getDefaultInstanceForType() {
        return controller.Protocol.Request.getDefaultInstance();
      }

      public controller.Protocol.Request build() {
        controller.Protocol.Request result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public controller.Protocol.Request buildPartial() {
        controller.Protocol.Request result = new controller.Protocol.Request(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        controller.Protocol.Request parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
      ...
      private controller.Protocol.Request.Type type_ = controller.Protocol.Request.Type.Buy;
      /**
       * <code>required .controller.Request.Type type = 1;</code>
       */
      public boolean hasType() {
  ...
  public static final class Reply extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        output.writeBytes(2, getDescritionBytes());
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000002) == 0x00000002)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(2, getDescritionBytes());
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSerializedSize = size;
      return size;
    ...
    public static controller.Protocol.Reply parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static controller.Protocol.Reply parseFrom(
    ...
    public static final class Builder extends
      ...
      // Construct using controller.Protocol.Reply.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public controller.Protocol.Reply getDefaultInstanceForType() {
        return controller.Protocol.Reply.getDefaultInstance();
      }

      public controller.Protocol.Reply build() {
        controller.Protocol.Reply result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public controller.Protocol.Reply buildPartial() {
        controller.Protocol.Reply result = new controller.Protocol.Reply(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        controller.Protocol.Reply parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
